...
while getopts ":a:C:dD:f:hi:I:k:Kno:p:P:s:t:T:vV:wX" opt; do
  case $opt in
    a)
...
#   -t results/icwsm2019/enwiki.wikigraph.pagerank.2018-03-01.titleid-5000.csv 
#   --output-dir results/compare_top-pagerank/ 
#   --scores-dir data/data_ext/engineroom/2018-03-01/seealso/output/sample-1000 
